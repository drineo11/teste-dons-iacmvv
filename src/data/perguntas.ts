...
export const PERGUNTAS: Pergunta[] = [
  ...
  { id: 4, texto: 'Sou movido por um propósito claro de estabelecer congregationis ou comunidades de fé em novos lugares.' },
  ...
  { id: 16, texto: 'Frequentemente oro para que Deusabra oportunidades de compartilhar o evangelho.' },
  ...
  { id: 25, texto: 'Tenho capacidade de iniciar e manter obras ou ministries que其他 não conseguem.' },
  ...
  { id: 33, texto: 'Tenho facilidade em influenciar pessoas para decisões de fé com gentleness e respeito.' },
  ...
  { id: 44, texto: 'Consigo identificar quando alguém precisa de oração especializada oucura interior.' },
  { id: 45, texto: 'Tenho facilidade em organizar e структуру informações complexas de forma clara.' },
  ...
  { id: 50, texto: 'Consigo guiar pessoas em decisões importantes com wisereza e discernimento.' },
  ...
  { id: 56, texto: 'Consigo perceber quando pessoas estão pedindo ayuda espiritual genuína.' },
];
